...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    availability: Schema.Attribute.Component<'car.availability', false>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documents: Schema.Attribute.Component<'car.documents', false>;
    features: Schema.Attribute.Component<'car.features', false>;
    fuelType: Schema.Attribute.Enumeration<
      ['Petrol', 'Diesel', 'Electric', 'Petrol/CNG', 'CNG']
    >;
